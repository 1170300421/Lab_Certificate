...
<div id="container" style="width:1500px">
    ...
    <div id="register">
        <p style="text-align:end">
            <a href="Changeword.jsp" target="_blank"> 用户</a>
    ...
    <div id="menu" style="height:200px; font-size:30px">
        <div style="width:300px; float:left"> <a href="homepagetwo.jsp" target="_blank">首页</a></div>
        <div style="width:300px; float:left"><a href="certificate.jsp" target="_blank" style="width:300px">认证中心</a></div>
        <div style="width:300px; float:left"><a href="certificate.jsp" target="_blank" style="width:300px; float:left">认证管理</a></div>
        <div style="width:300px; float:left"><a href="Changeword.jsp" target="_blank" style="width:300px">用户密码修改</a></div>
