...
<table border="0px" width="1300px" align="center" cellpadding="0px" cellspacing="0px">
            ...
            <table border="0px" width="100%">
                <tr height="50px">
                    ...
                    <td width="33.3%" align="right">
                        <a href="login.jsp"><font size="3" color="#1A42D2">用户</a>
                        &nbsp;&nbsp;
    ...
    <tr>
        <td>
            <ul id="demo">
                <li class="active"> <a href="http://www.quwan.com/goods_2013-34121.html?fm=searchlist2"><img src="../img/lunbotu/pag1.jpg"  /></a>
                    <div><a href="register.jsp">注册</a></div>
                </li>
                <li> <a href="login.jsp"><img src="../img/lunbotu/pag2.jpg"  /></a>
                    <div><a href="http://www.quwan.com/goods_2013-41248.html?fm=searchlist2">登录</a></div>
                </li>
                <li > <a href="certificate.jsp"><img src="../img/lunbotu/pag3.jpg"  /></a>
