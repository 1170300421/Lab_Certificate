                ...
                <form action="#" method="get" name="regForm" onsubmit="return checkForm()">
                    <table border="0px" width="40%" height="400px" align="center" cellpadding="0px" cellspacing="0px" bgcolor="#FAFAFA">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="rname" size="34px" id="rname" onfocus="showTips('name','请输入姓名')" onblur="check('name','姓名不能为空！')"/><span id="namespan"></span>
                            </td>
                        </tr>
                        <tr>
                            <td>
...
<script>
    ...
    cities[0] = new Array("哈尔滨市","大庆市","福州市","莆田市");
