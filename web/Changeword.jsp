            ...
            <table border="0px" width="100%">
                <tr height="50px">
                    ...
                    <td width="33.3%" align="right">
                        ...
                        <a href="Changeword.jsp"><font size="3" color="#1A42D2">后台管理系统</a>
                    </td>
                </tr>
            </table>
        </td>
                ...
                <div class="mycenter">
                    <div class="mysign">
                        ...
                        <form name="frm" action="LoginServlet" method="post">
                            ...
                            <div class="col-lg-10">
                                <input type="password" class="form-control" id="Password"  name="Password" placeholder="请输入原密码" required autofocus value="${param.Password}"/>
                            </div>
                            <div class="col-lg-10">
                                <input type="password" class="form-control" id="Changeword"  name="Changeword" placeholder="请输入新密码" required autofocus value="${param.Changeword}"/>
                            </div>
                            <div class="col-lg-10"></div>
                            ...
                            <div class="col-lg-10"></div>
                            <div class="col-lg-10">
                                <input type="submit" value="修改" onclick="trans()"/>
                            </div>
                    </div>
                </div>
